...
export default function Pekerjaan() {
      ...
      <form className="w-full max-w-lg">
            <div className="flex flex-wrap -mx-3 mb-6">
              <div className="w-full px-3">
                ...
                <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-first-name" type="text" placeholder="Masukkan Nama Pekerjaan..." />
              </div>
            </div>
  ...
  const mdlEditDataContent = (
    <div className="p-4">
      <h1 className="text-center font-bold">Edit Data Pekerjaan</h1>
      <br />
      <form className="w-full max-w-lg">
            <div className="flex flex-wrap -mx-3 mb-6">
              <div className="w-full px-3">
  ...
  const tableData = {
    headers: ['No', 'Nama Pekerjaan', 'Status', 'Action'],
    rows: [
      [1, 'Karyawan Swasta', 'Yes', <div key="Aksi" className="container mx-auto"><Aksi content={mdlEditDataContent}/></div>],
