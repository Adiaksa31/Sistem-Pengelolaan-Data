        ...
        <div className="pt-3 pb-4 px-10 text-sm font-medium text-center text-black">
            <ul className="flex flex-wrap space-x-3 -mb-px">
                ...
                {user?.posisi.id === 3 || user?.posisi.id === 4 || user?.posisi.id === 8 ? (
                    <li className="me-2">
                        <a href="#" className="inline-block py-2 border-b-2 rounded-t-lg hover:text-D32124 hover:border-D32124">Prospek Sale</a>
                    </li>
                ) : null}
                ...
                {user?.posisi.id === 5 || user?.posisi.id === 7 ? (
                    <li className="me-2">
                        <a href="#" className="inline-block py-2 border-b-2 rounded-t-lg hover:text-D32124 hover:border-D32124">Booking Service</a>
                    </li>
                ) : null}
                ...
                {user?.posisi.id === 5 || user?.posisi.id === 6 ? (
                    <li className="me-2">
                        <a href="#" className="inline-block py-2 border-b-2 rounded-t-lg hover:text-D32124 hover:border-D32124">Sparepart</a>
                    </li>
                ) : null}

                {/* selalu ada */}
                <li className="me-2">
                    <a href="#" className="inline-block py-2 border-b-2 rounded-t-lg hover:text-D32124 hover:border-D32124 ">Keluhan</a>
                </li>
            </ul>
        </div>
        </>
